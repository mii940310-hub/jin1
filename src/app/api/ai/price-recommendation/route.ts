...
export async function POST(req: Request) {
    ...
    가격 기준은 반드시 **이마트나 롯데마트 같은 대형 마트보다는 저렴하게, 그리고 쿠팡이나 네이버 쇼핑 최저가보다는 30% 정도 더 저렴하게** 파격적인 산지 직송 가격으로 기준을 잡아주세요.
    소비자에게 매우 저렴한 가격에 제공하여 판매량을 늘리는 전략을 취하되, 농가에게도 직거래를 통해 유통 마진을 돌려주는 방향으로 분석해 주세요. 
